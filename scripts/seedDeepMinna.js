    ...
    points: [
      {
        ...
        examples: [
          { jp: "わたしはマイク・ミラーです。", rom: "Watashi wa Maiku Mirā desu.", id: "Saya adalah Mike Miller." },
          { jp: "シュミットさんはエンジニアです。", rom: "Shumitto-san wa enjinia desu.", id: "Sdr. Schmidt adalah seorang insinyur." }
        ]
      },
      {
        ...
        examples: [
          { jp: "サントスさんは学生じゃありません。", rom: "Santosu-san wa gakusei ja arimasen.", id: "Sdr. Santos bukan seorang pelajar." },
          { jp: "わたしは医者ではありません。", rom: "Watashi wa isha dewa arimasen.", id: "Saya bukan seorang dokter. (Sangat formal)" }
        ]
      },
      {
        ...
        examples: [
          { jp: "ミラーさんはアメリカ人ですか。", rom: "Miraa-san wa Amerika-jin desu ka.", id: "Apakah Sdr. Miller orang Amerika?" },
          { jp: "はい、アメリカ人です。", rom: "Hai, Amerika-jin desu.", id: "Ya, orang Amerika." }
        ]
      },
      {
        pattern: "N も (Juga)",
        ...
        examples: [
          { jp: "ミラーさんは会社員です。グプタさんも会社員です。", rom: "Miraa-san wa kaishain desu. Guputa-san mo kaishain desu.", id: "Sdr. Miller adalah karyawan. Sdr. Gupta juga karyawan." }
        ]
      },
      {
        ...
        examples: [
          { jp: "IMCの社員", rom: "IMC no shain", id: "Karyawan (dari perusahaan) IMC." },
          { jp: "わたしの本", rom: "Watashi no hon", id: "Buku milik saya." }
        ]
      }
    ]
  },
    ...
    points: [
      {
        ...
        examples: [
          { jp: "これは辞書です。", rom: "Kore wa jisho desu.", id: "Ini (di dekatku) adalah kamus." },
          { jp: "それは傘ですか。", rom: "Sore wa kasa desu ka.", id: "Apakah itu (di dekatmu) payung?" }
        ]
      },
      {
        ...
        examples: [
          { jp: "この本はわたしのです。", rom: "Kono hon wa watashi no desu.", id: "Buku ini adalah milik saya." },
          { jp: "あの人は誰ですか。", rom: "Ano hito wa dare desu ka.", id: "Orang itu (di sana) siapa?" }
        ]
      },
      {
        ...
        examples: [
          { jp: "それはテレホンカードですか。", rom: "Sore wa terehonkaado desu ka.", id: "Apakah itu kartu telepon?" },
          { jp: "はい、そうです。", rom: "Hai, sou desu.", id: "Ya, benar (begitu)." },
          { jp: "いいえ、違います。", rom: "Iie, chigaimasu.", id: "Tidak, keliru / bukan." }
        ]
      }
    ]
  },
    ...
    points: [
      {
        ...
        examples: [
          { jp: "お手洗いはあそこです。", rom: "Otearai wa asoko desu.", id: "Toilet ada di sana." },
          { jp: "エレベーターはどこですか。", rom: "Erebeetaa wa doko desu ka.", id: "Lift ada di mana?" }
        ]
      },
      {
        ...
        examples: [
          { jp: "会議室はこちらです。", rom: "Kaigishitsu wa kochira desu.", id: "Ruang rapat ada di sebelah sini." },
          { jp: "お国はどちらですか。", rom: "Okuni wa dochira desu ka.", id: "Negara Anda di mana? (Berasal dari negara mana?)" }
        ]
      },
      {
        ...
        examples: [
          { jp: "これはどこのコンピューターですか。", rom: "Kore wa doko no konpyuutaa desu ka.", id: "Ini komputer buatan mana?" },
          { jp: "日本のコンピューターです。", rom: "Nihon no konpyuutaa desu.", id: "Komputer buatan Jepang." }
        ]
      }
    ]
  },
    ...
    points: [
      {
        ...
        examples: [
          { jp: "毎日勉強します。", rom: "Mainichi benkyou shimasu.", id: "Setiap hari belajar. (Kebiasaan/Positif)" },
          { jp: "きのう勉強しませんでした。", rom: "Kinou benkyou shimasen deshita.", id: "Kemarin tidak belajar. (Lampau/Negatif)" }
        ]
      },
      {
        pattern: "～時 ～分 に V",
        ...
        examples: [
          { jp: "６時半に起きます。", rom: "Rokuji han ni okimasu.", id: "Bangun pada jam 6.30." },
          { jp: "明日勉強します。", rom: "Ashita benkyou shimasu.", id: "Besok saya belajar. (Tanpa partikel 'ni')" }
        ]
      },
      {
        pattern: "～から ～まで",
        ...
        examples: [
          { jp: "９時から５時まで働きます。", rom: "Kuji kara goji made hatarakimasu.", id: "Bekerja dari jam 9 sampai jam 5." },
          { jp: "銀行は９時からです。", rom: "Ginkou wa kuji kara desu.", id: "Bank (buka) dari jam 9." }
        ]
      }
    ]
  },
    ...
    points: [
      {
        ...
        examples: [
          { jp: "明日京都へ行きます。", rom: "Ashita Kyouto e ikimasu.", id: "Besok pergi ke Kyoto." },
          { jp: "うちへ帰ります。", rom: "Uchi e kaerimasu.", id: "Pulang ke rumah." }
        ]
      },
      {
        pattern: "どこへも行きません",
        ...
        examples: [
          { jp: "日曜日はどこへも行きませんでした。", rom: "Nichiyoubi wa doko e mo ikimasen deshita.", id: "Hari minggu tidak pergi ke mana pun." }
        ]
      },
      {
        ...
        examples: [
          { jp: "自転車で学校へ行きます。", rom: "Jitensha de gakkou e ikimasu.", id: "Pergi ke sekolah dengan sepeda." },
          { jp: "歩いて帰ります。", rom: "Aruite kaerimasu.", id: "Pulang dengan berjalan kaki." }
        ]
      },
      {
        ...
        examples: [
          { jp: "家族と日本へ来ました。", rom: "Kazoku to Nihon e kimashita.", id: "Datang ke Jepang bersama keluarga." },
          { jp: "一人で東京へ行きます。", rom: "Hitori de Toukyou e ikimasu.", id: "Pergi ke Tokyo sendirian." }
        ]
      }
    ]
  }
...
const fileContent = `// Deep digest version of Minna no Nihongo Data\nexport const MINNA_LESSONS = ${JSON.stringify(MINNA_LESSONS, null, 2)};\n`;
fs.writeFileSync(path.join(__dirname, '../src/data/minnaData.js'), fileContent);
console.log('Successfully enhanced minnaData.js with deep digest format (Lessons 1-5).');
